...
abstract class $UserDataCopyWith<$Res> {
  ...
  @useResult
  $Res call({String userId, String marketplace});
}
...
class _$_UserData extends _UserData with DiagnosticableTreeMixin {
  const _$_UserData({this.userId = '', this.marketplace = ''}) : super._();
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserData(userId: $userId, marketplace: $marketplace)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('marketplace', marketplace));
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, userId, marketplace);
...
abstract class _UserData extends UserData {
  const factory _UserData({final String userId, final String marketplace}) =
      _$_UserData;
